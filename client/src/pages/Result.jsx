...
const Result = () => {
  ...
  const onSubmitHandler = async(e) => {
    ...
    try {
      ...
      alert((response && response.message) || "Failed to generate image. Please try again.");
    }
    } catch (error) {
  ...
  <span className={` absolute bottom-0 left-0 h-1 bg-blue-500 ${Loading ? 'w-full transition-all duration-[105]': 'w-0'} `} />
  </div>
  ...
  <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.55 mt-10 rounded-full'>
