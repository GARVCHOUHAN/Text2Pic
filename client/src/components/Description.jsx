...
const Description = () => {
  return (
    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        ...
        <h1 className='text-3x1 sm:text-4xl font-semibold mb-2'>Create AI Images</h1>

        <p className='text-gray-500 mb-8'>Turn your imagination into visuals</p> I


    <div className='flex flex-col gap-5 md"gap-5 md:gap-14 md:flex-row items-center'>
            <img src={assets.sample_img_1} className='w-8- xl:w-96 rounded-lg' alt="" />
        <div>
