...
//     const { user, setShowLogin, setUser, setToken ,logout,creditBalance} = useContext(AppContext)
...
//       <p className='text-xs sm:text-sm font-medium text-gray-600'>Credits left: {user.creditBalance} </p>
//         </button>
...
//             <li 
//             onClick={logout}
//             className='py-1 px-1 cursor-pointer pr-5'>Logout</li>
//           </ul>
//         </div>
//         </div>
...
//           className='bg-zinc-800 text-white px-10 py-2 
                    ...
                    <div className='flex items-center gap-2 sm:gap-3'>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                                <ul className='list-none m-0 p-2 bg-white roundded-md border text-sm'>
                                    <li onClick={logout} className='py-1 px-1 cursor-pointer pr-5'>Logout</li>
                                </ul>
                            </div>
                        </div>
                    </div>
